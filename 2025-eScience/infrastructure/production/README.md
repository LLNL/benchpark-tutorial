# Deploy escience-2025-tutorial to AWS Elastic Kubernetes Service (EKS)

These config files and scripts can be used to deploy the escience-2025-tutorial tutorial to EKS.
