# Deploy escience-2025-dry-run to AWS Elastic Kubernetes Service (EKS)

These config files and scripts can be used to deploy the escience-2025-dry-run tutorial to EKS.
