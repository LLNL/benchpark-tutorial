...
This directory contains the materials for the ISC 2026 tutorial. The following subsections go over the contains of the material.
...
like :code:`ghcr.io/llnl/benchpark:isc-2026`. Note that :code:`<iamge_name>` **must** match the value of the :code:`FROM` directive
