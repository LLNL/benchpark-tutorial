...
eksctl delete cluster --config-file /Users/lumsden1/projects/pave/hpdc-tutorial/hpdc-tutorial-docker-test/2025-HPDC/infrastructure/test-c7i-metal-48xl/eksctl-config.yaml --wait
