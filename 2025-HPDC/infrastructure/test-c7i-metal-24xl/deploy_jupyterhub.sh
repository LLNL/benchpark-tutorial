...
helm install hpdc-2025-c7i-metal-24xl-jupyter jupyterhub/jupyterhub --version 4.2.0 --values /Users/lumsden1/projects/pave/hpdc-tutorial/hpdc-tutorial-docker-test/2025-HPDC/infrastructure/test-c7i-metal-24xl/helm-config.yaml
