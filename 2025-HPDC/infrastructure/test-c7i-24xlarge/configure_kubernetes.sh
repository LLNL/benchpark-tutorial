...
kubectl apply -f /Users/lumsden1/projects/pave/hpdc-tutorial/hpdc-tutorial-docker-test/2025-HPDC/infrastructure/test-c7i-24xlarge/cluster-autoscaler.yaml
echo ""
echo "Configuring the Storage Class:"
kubectl apply -f /Users/lumsden1/projects/pave/hpdc-tutorial/hpdc-tutorial-docker-test/2025-HPDC/infrastructure/test-c7i-24xlarge/storage-class.yaml
